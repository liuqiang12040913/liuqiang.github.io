<!DOCTYPE html>
<html lang="en" class="gr__webpages_uncc_edu"><!-- === Header Starts === --><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">

  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="description" content="Qiang Liu&#39;s home page.">
  <meta name="keywords" content="Qiang Liu, Wireless Networking, Edge Computing, Machine Learning">
  <meta name="author" content="Qiang Liu">

  <title>Qiang Liu, Ph.D.</title>
...
<!-- === Navigation Bar (Vertical) Starts === -->
<div class="navbar-vertical">
  <a href="https://liuqiang12040913.github.io/#"><img src="./assets/figures/me.jpg" width="100px" class="rounded-circle img-thumbnail"></a>
  <h5 class="mt-10"><button onclick="window.location.href='publications.html'">Qiang Liu</button></h5>
  <ul class="nav flex-column mt-20">
    <li class="nav-item active"><a href="https://liuqiang12040913.github.io/#home" class="nav-link">Home</a></li>
    <li class="nav-item"><a href="https://liuqiang12040913.github.io/#experience" class="nav-link">Experiences</a></li>
    <li class="nav-item"><a href="https://liuqiang12040913.github.io/#publication" class="nav-link">Publications</a></li>
    <li class="nav-item"><a href="https://liuqiang12040913.github.io/#honor" class="nav-link">Honors &amp; Awards</a></li>
    <li class="nav-item"><a href="https://liuqiang12040913.github.io/#skill" class="nav-link">Skills</a></li>
    <li class="nav-item"><a href="https://liuqiang12040913.github.io/#contact" class="nav-link">Contact</a></li>
  </ul>
  <p class="mt-20">
    ...
    <a class="icon" href="https://www.linkedin.com/in/qiang-liu-6b4424129/" target="_blank">
...
<div id="home" class="section">
  ...
  <p>
    I am an Assistant Professor at the <a href="https://cse.unl.edu/home" target="_blank">Department of Computer Science and Engineering</a>, <a href="https://www.unl.edu/" target="_blank"> University of Nebraska - Lincoln</a>. 
    I was a Member of Technical Staff at <a href="https://www.bell-labs.com/" target="_blank">Nokia Bell Labs</a>. I obtained my Ph.D. in Electrical Engineering at the <a href="https://www.uncc.edu" target="_blank">University of North Carolina at Charlotte</a>, supervised by
    <a href="https://webpages.uncc.edu/than3/index.html" target="_blank">Prof. Tao Han</a>.
    My research covers the broad field of <b>Wireless Communication</b>, <b>Computer Networking</b>, <b>Machine Learning</b>, and <b>Edge Computing</b>, with special interests in LTE/5G, Network Slicing, AR/VR, IoT, V2X, and DL/RL. 
    I received my M.S. in Communication and Information System at <a href="https://www.uestc.edu.cn/" target="_blank">University of Electronic Science and Technology of China</a>.
    I have extensive research experience in both academia, e.g., <a href="https://www.ncl.uestc.edu.cn/" target="_blank">NCL</a> at UESTC and <a href="https://webpages.uncc.edu/than3/TaoLab/" target="_blank">WinSYS</a> at UNC-Charlotte, and industry labs, e.g., <a href="https://www.bell-labs.com/" target="_blank">Nokia Bell Labs</a>, <a href="https://about.fb.com/realitylabs/" target="_blank">Facebook Reality Labs</a>, <a href="https://www.tytlabs.com/" target="_blank">Toyota InfoTech Labs</a>, and <a href="https://www.noahlab.com.hk/#/home" target="_blank">Huawei 2012 Labs</a>.
  </p>
  <div class="title">News</div>
  <ul>
    <li>[2021/08] I will start a graduate-level course Fall 2021, <a href="https://newsroom.unl.edu/announce/cse/13137/75850" target="_blank">CSCE 990 (Multi-Access Edge Computing)</a>!</li>
    <li>[2021/08] I offically join CSE department at UNL as an Assistant Professor!</li>
    <li>[2021/01] I offically join Nokia Bell Labs as a network system researcher!</li>
    <li>[2020/12] One paper is accepted by IEEE INFOCOM 2021!</li>
...
<div id="experience" class="section">
 ...
 <!-- === Nokia === -->
  <div class="item small">
    <div class="image">
      <a href="https://www.unl.edu/" ,="" target="_blank">
        <img src="./assets/figures/unl.jpeg">
      </a>
    </div>
    <div class="text">
      <b>Nokia</b> (Aug. 2021 - Present) <br>
      Assistant Professor
    </div>
  </div>
  ...
  <div class="item small">
    <div class="image">
      <a href="http://www.bell-labs.com/" ,="" target="_blank">
        <img src="./assets/figures/bell_labs.png">
      </a>
    </div>
    <div class="text">
      <b>Nokia</b> (Feb. 2021 - Aug. 2021) <br>
      Member of Technical Staff - Network System Researcher
    </div>
  </div>
  ...
  <div class="item small">
    ...
    <div class="text">
      <b>UNC-Charlotte</b> (Aug. 2016 - Dec. 2020) <br>
  ...
  <div class="item small">
    ...
    <div class="text">
      ...
      M.S. Student in Communication and Information System
    </div>
  </div>
  ...
  <div class="item small">
    <div class="image">
      <a href="http://www.noahlab.com.hk/#/home" target="_blank">
        <img src="./assets/figures/huawei.png">
      </a>
    </div>
    <div class="text">
...
<div id="publication" class="section">
  ...
  <div class="subtitle">Conferences</div>
	  ...
	  <div style="float:right; width:80%;">
		  <a href="https://arxiv.org/abs/2012.10252" ,="" target="_blank">
...
<div id="skill" class="section">
  ...
  <ul>
    <li><b>Programming Language</b>: Python, C/C++, Java, Matlab
...
<div id="contact" class="section last">
  ...
  <ul class="list-unstyled ml-5">
    <li>
      ...
      <a href="mailto:liuqiang12040913@gmail.com">liuqiang12040913@gmail.com</a>
    </li>
<!--
    <li>
...
<!-- === Back-to-Top Button === -->
<a href="" class="back-to-top-button"><i class="fa fa-arrow-up"></i></a>
<!-- === Back-to-Top Button === -->
