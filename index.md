...
<html lang="en" class="gr__webpages_uncc_edu"><!-- === Header Starts === --><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <meta name="keywords" content="Qiang Liu, UNCC, Wireless Networking, Edge Computing, AR/VR, Machine Learning">
...
<div class="navbar-vertical">
  <a href="https://webpages.uncc.edu/qliu12/#"><img src="./assets/figures/me.jpg" width="100px" class="rounded-circle img-thumbnail"></a>
...
<div id="home" class="section">
  ...
  <div class="title"><button onclick="window.location.href='publications.html'">About Me</button></div>
  <p>
